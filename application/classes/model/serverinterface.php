...
class Model_ServerInterface extends Model_Entity
{
	...
	{
		$this->logUse();
		$str  = "ServerInterface: {$this->id}, server->{$this->server->icingaName} vlan={$this->vlan->name}, name={$this->name}, hostname={$this->hostname}, cname={$this->cname}, mac={$this->externalMac}, switchport={$this->switchport}, cable={$this->cable}, IPv4Addr={$this->IPv4Addr}, IPv6Addr={$this->IPv6Addr}";
		return $str;
	}
