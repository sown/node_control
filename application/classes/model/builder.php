...
class Model_Builder
{
	public static function create_node($boxNumber = '', $vpnServerId = 0, $wiredMac = '', $wirelessMac = '', $firmwareVersion = '', $firmwareImage = '')
	{
		...
		$node = Model_Node::build($boxNumber, $firmwareVersion, $firmwareImage, $certificate, $vpnEndpoint);
